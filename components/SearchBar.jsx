    ...
    <>
      <div className="flex-1 flexCenter dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 py-3 px-4 rounded-md">
        ...
        <input
          ...
          className="dark:bg-nft-black-2 bg-white mx-4 w-full dark:text-white text-nft-black-1
      ...
      {toggle && (
        <div
          className="top-full mt-3 z-10 dark:bg-nft-black-2 bg-white border
  dark:border-nft-black-2 border-nft-gray-2 py-3 px-4 rounded-md"
        >
