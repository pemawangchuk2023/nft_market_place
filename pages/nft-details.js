      ...
      <div className='flex-1 flexStartCenter'>
        <div className='relative w-28 h-28'>
          <Image
            ...
            objectFit='cover'
            className='rounder-xl shadow-lg'
            layout='fill'
          />
        </div>
  ...
  return (
    <div className='relative flex justify-center md:flex-col min-h-screen'>
      ...
      <div className='flex-1 justify-start sm:px-4 p-12 sm:pb-4'>
        ...
        <div className='mt-10'>
          <p className='font-poppins font-semibold dark:text-white text-nft-black-1 text-xs minlg:text-base'>
            Owner
          </p>
          <div className='flex flex-row items-center mt-3'>
            <div className='relative w-12 h-12 minglg:w-20 minlg:h-20 mr-2'>
              <Image
                src={images.creator1}
                objectFit='cover'
      ...
      {isLoadingNFT && (
        <Modal
          header='Buying NFT...'
          body={
            <div className='flexCenter flex-col tetx-center'>
